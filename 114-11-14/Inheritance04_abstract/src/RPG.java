public class RPG {
    public static void main(String[] args) {
        ...
        ShieldSwordMan shieldSwordMan = new ShieldSwordMan("持盾劍士", 120, 18);

        Role[] gameRoles = {swordsMan_light, swordsMan_dark, magician_light, magician_dark,shieldSwordMan};
